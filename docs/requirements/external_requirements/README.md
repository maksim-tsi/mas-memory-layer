...
**Status:** Source submissions  
**Last updated:** 2026-05-24

This directory contains customer-provided YAAM interface requirement documents.
These files are treated as source evidence for the requirements registry.

Current submissions:

| Customer system | File |
|---|---|
| TRA | [TRA-yaam-interface-requirements.md](TRA-yaam-interface-requirements.md) |
| iAIMS | [IAMS-yaam-interface-requirements.md](IAMS-yaam-interface-requirements.md) |
...
- Do not rewrite customer submissions during normalization.
- Capture normalized requirements in
  [../yaam-requirements-registry.md](../yaam-requirements-registry.md).
