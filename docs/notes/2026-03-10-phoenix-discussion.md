...
Read [](../plan/2026-03-10-yaam-glassbox-observability-gap-closure-plan.md)
...
Searched for regex `yaam.retriever.l3|yaam.retriever.l4|query_memory\(\)|L3|L4|selected evidence metadata|retriever spans around` (`**/docs/plan/2026-03-10-yaam-glassbox-observability-gap-closure-plan.md`), 4 results
